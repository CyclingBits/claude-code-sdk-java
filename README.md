...
[![Maven Central](https://img.shields.io/maven-central/v/net.cyclingbits/claude-code-sdk-java)](https://central.sonatype.com/artifact/net.cyclingbits/claude-code-sdk-java/1.1.1)
[![javadoc](https://javadoc.io/badge2/net.cyclingbits/claude-code-sdk-java/javadoc.svg)](https://javadoc.io/doc/net.cyclingbits/claude-code-sdk-java/1.1.1)
...
<!-- x-release-please-start-version -->
```gradle
implementation 'net.cyclingbits:claude-code-sdk-java:1.1.1'
```
<!-- x-release-please-end -->
